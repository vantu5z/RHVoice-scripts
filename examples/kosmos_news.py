    ...
    if "<title>" in line:  # фильтруем по строкам с названием новости
      ...
      if line != "Независимый портал космонавтики." :  # пропускаем эту строку
          ...
          if metka_new == 0:
            ...
            time.sleep(1)
            metka_new = 1               # отметка, что уже сказали вступление
          RHVoice_say(line)
          time.sleep(1)
...
if metka_new == 1: RHVoice_say("Вот и все новости на этот час. Спасибо за внимание.")  # говорим, если были свежие новости
